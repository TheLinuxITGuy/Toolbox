...
if ! command -v $APP_NAME &> /dev/null; then
    ...
    sudo nala update -qq || error_exit "Failed to update package database."
    # Install the app
    ...
    sudo nala install -f -y || error_exit "Failed to install some dependencies. Please check your system settings."
else
