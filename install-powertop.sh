...
# Function to install Powertop on Debian/Ubuntu-based systems
install_nala() {
...
# Function to install Powertop on Arch-based systems
install_pacman() {
...
# Function to install Powertop on Fedora-based systems
install_dnf() {
